...
const I18N = {
  ...
  DICTIONARY: {
    it: {
      ...
      tabForm: "📋 Scheda Dati",
      tabVideo: "🎥 Video & Angoli (Pose & Cadenza)",
      tabDiagnostics: "🩺 Diagnosi & Proposte",
      tabCalculator: "📐 Calcolatori & Simulatore Cockpit",
      tabComparison: "⚖️ Confronto Sincronizzato",
      ...
      btnStepBack: "⏪ -1 fr",
      btnStepFwd: "⏩ +1 fr",
      btnSeekBDC: "🎯 Salta al BDC",
      btnSnapshot: "📸 Cattura Foto con Angoli",
      ...
      camLevelOk: "In bolla",
      camWarnTiltForward: "⚠️ Camera inclinata in avanti! Raddrizza lo smartphone.",
      camWarnTiltBack: "⚠️ Camera inclinata indietro! Raddrizza lo smartphone.",
      camWarnRoll: "⚠️ Camera storta lateralmente! Allinea la livella.",
      camAngleOk: "90° Sagittale OK",
      camWarnDiagonal: "⚠️ Camera diagonale! Spostati a 90° di lato alla bici.",
      camFramingOk: "Inquadratura OK",
      camWarnPedalsCut: "⚠️ Pedali tagliati in basso! Allontana o abbassa la camera.",
      camWarnHeadCut: "⚠️ Testa o spalle tagliate in alto! Allontana la camera.",
      camWarnTooClose: "⚠️ Troppo vicino! Inquadra l'intera bici e il ciclista.",
      camWarnTooFar: "⚠️ Troppo lontano! Avvicina la camera per maggiore precisione.",
      camWarnNoRider: "ℹ️ Nessun ciclista rilevato in sella.",
      camWarnBikeAlign: "Allinea la sagoma della bici con l'orizzonte e l'asse ruote.",
      camStatusReadyToRecord: "✅ Inquadratura perfetta! Pronto a registrare.",
      ...
      btnDownloadRecordedVideo: "💾 Scarica Clip Registrata",
    ...
    en: {
      ...
      btnCopy: "📋 Copy",
      btnReset: "Reset form",
      tabForm: "📋 Rider & Bike Data",
      tabVideo: "🎥 Video & Angles (Pose & Cadence)",
      tabDiagnostics: "🩺 Diagnostics & Action Plan",
      tabCalculator: "📐 Calculators & Cockpit Simulator",
      tabComparison: "⚖️ Synchronized Video Comparison",
      ...
      btnStepBack: "⏪ -1 fr",
      btnStepFwd: "⏩ +1 fr",
      btnSeekBDC: "🎯 Jump to BDC",
      btnSnapshot: "📸 Capture Photo with Angles",
      btnSaveAngles: "📝 Save Angles to Form",
      ...
      camLevelOk: "Level OK",
      camWarnTiltForward: "⚠️ Camera tilted forward! Straighten your phone.",
      camWarnTiltBack: "⚠️ Camera tilted back! Straighten your phone.",
      camWarnRoll: "⚠️ Camera tilted sideways! Align the spirit level.",
      camAngleOk: "90° Sagittal OK",
      camWarnDiagonal: "⚠️ Diagonal camera angle! Move directly to the side (90°) of the bike.",
      camFramingOk: "Framing OK",
      camWarnPedalsCut: "⚠️ Pedals cut off at bottom! Move camera back or lower it.",
      camWarnHeadCut: "⚠️ Head or shoulders cut off at top! Move camera back.",
      camWarnTooClose: "⚠️ Too close! Fit the entire bike and rider in frame.",
      camWarnTooFar: "⚠️ Too far! Move camera closer for higher accuracy.",
      camWarnNoRider: "ℹ️ No rider detected on bike.",
      camWarnBikeAlign: "Align the bike outline with the horizon and wheel axles.",
      camStatusReadyToRecord: "✅ Perfect framing! Ready to record.",
      ...
      btnDownloadRecordedVideo: "💾 Download Recorded Clip",
